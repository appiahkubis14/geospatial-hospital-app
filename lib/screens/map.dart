...
class WebViewMap extends StatefulWidget {
  ...
  const WebViewMap({Key? key, required this.url}) : super(key: key);
    ...
    if (user != null) {
      try {
        ...
        if (doc.exists) {
          ...
          if (userData.containsKey('image_url')) {
            setState(() {
        ...
        ScaffoldMessenger(
            child: SnackBar(content: Text('Error fetching user data: $e')));
    ...
    return Scaffold(
      appBar: AppBar(
        title: const TextScroll(
          ...
          'WELCOME TO HOSPITAL ROUTING MAP VIEW GENERATED BY ACCUGEOSPATIAL',
        ...
        actions: [
          Container(
            ...
            decoration: const BoxDecoration(
              color: Color.fromARGB(255, 55, 172, 180),
          ...
          Padding(
            ...
            child: CircleAvatar(
                ...
                backgroundImage: _imageUrl.isNotEmpty
                    ...
                    : NetworkImage(imageAvator) // Default image
                ),
          ),
        ],
      ),
